...
public class EmployeeController {
    ...
    public ModelAndView getListEmployees(@RequestParam("name") Optional<String> name, @RequestParam("dept") Optional<String> dept, Pageable pageable){
...
//        LocalDateTime ldt = LocalDateTime.ofInstant(employee.getBirthDay().toInstant(), ZoneId.systemDefault());
//        String date = DateTimeFormatter.ofPattern("yyyy-MM-dd", Locale.ENGLISH).format(ldt);
//        Date dateParse = SimpleDateFormat.getDateInstance().parse(date);
//        employee.setBirthDay(dateParse);
